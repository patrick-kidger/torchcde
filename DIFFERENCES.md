...
- Linear interpolation, reparameterised linear interpolation, and multiple-interval linear interpolation are now available, via `linear_interpolation_coeffs` and `LinearInterpolation`.
