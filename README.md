...
See the paper [Neural Rough Differential Equations for Long Time Series](https://arxiv.org/abs/2009.08295) for more information. See [./examples/logsignature_example.py] for a worked example.
